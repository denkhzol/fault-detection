...
def main():
    ...
    #trainer_config = TrainerConfig(batch_size=256, max_epochs=2, early_stopping="valid_loss", early_stopping_mode="min", early_stopping_patience=5, checkpoints="valid_loss", load_best=True)
